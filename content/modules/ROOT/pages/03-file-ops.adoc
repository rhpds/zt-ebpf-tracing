...
.filetoptab.png
image::../assets/filetoptab.png[filetoptab.png]
...
In the `+filetop+` tab in the terminal, you are going to see
applications accessing files in realtime, so this will get pretty busy.
...
part of the `+dnf update+` workload (which you have not run yet).
