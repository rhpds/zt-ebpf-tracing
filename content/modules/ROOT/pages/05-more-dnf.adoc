...
.Filetop output during `+dnf+` update
image::filetop_writing.png[filetop_writing.png]
...
.Xfsslower output during `+dnf+` update
image::xfsslower_writing.png[xfsslower_writing.png]
